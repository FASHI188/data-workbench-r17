...
0. Read `governance/INVESTMENT_CONTINUITY_RULES_V3.md` (currently V3.2). It is the stable continuation and context-budget rule layer and contains no dynamic project state.
