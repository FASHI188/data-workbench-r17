...
def parse_pdf_bytes(raw: bytes, economic_date: str) -> dict:
    """Production-promotion safety experiment; never formal runtime authority.
    ...
    and emit an experiment-only promoted object whose values must match the
    separately governed candidate artifact.
    """
