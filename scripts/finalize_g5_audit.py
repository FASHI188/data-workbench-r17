...
def main():
 ...
 if int(ctl.get('unresolved_economic_changes',-1))!=0:errors.append('unresolved independent factor changes remain')
 if int(ctl.get('ratio_mismatches',-1))!=0:errors.append('independent factor-ratio mismatches remain')
