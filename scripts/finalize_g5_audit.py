...
def main():
 ...
 if off.get('sse_native_control_missing',-1)!=0 or off.get('sse_native_control_conflicts',-1)!=0:errors.append('SSE native official components did not reconcile')
