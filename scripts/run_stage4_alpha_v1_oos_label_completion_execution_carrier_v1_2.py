...
IMPL_FP="45d25e1627b3c1b8d95371fd49997dc8c818e086915f85850274986d1a08adfd"
IMPL_ACCEPT_FP="1b6e05dd16911f9234c1ed4ee19918d30c37943dbb4be6b6490adb24b099849b"
ORIG_AUTH_FP="d260f1179c6f0c8cac8e2900e11c8f4cc6439eedc5515e02a00b69abb332449d"
PRIOR_LABEL_AUTH_FP="b6413b67ace2601bb03f2d45e7656ab3776ee3b9e90ecfe3ed32b92626eba16b"
PRIOR_LABEL_EVIDENCE_FP="2d41c39d4400b80bdd8d3f3cd6c6e0e85838b0531878cc0e10baf25070b993b6"
...
CONFIRM="CONSUME_SINGLE_USE_OOS_LABEL_COMPLETION_V1_2"
...
WORKFLOW_FILE="stage4-alpha-v1-oos-label-completion-execution-v1-2.yml"
AUTH_PATH="governance/stage4_alpha_v1_oos_label_completion_authorization_v1_2.json"
STATE_PATH="governance/accepted_project_state.json"
CONTRACT_PATH="governance/stage4_alpha_v1_oos_label_completion_execution_contract_v1_2.json"
RESERVATION_PATH="governance/stage4_alpha_v1_oos_label_completion_authorization_reservation_v1_2.json"
...
SRC={
 ...
 "scripts/stage4_alpha_v1_label_materialization.py":"07481bb2c20837b945b8a6deba06b76459c363d0c91e054b8a1029476881c18a",
...
def verify_static()->dict[str,bool]:
    ...
    ck("reservation",r.get("fingerprint")==RES_FP and canon(r.get("fingerprint_basis"))==RES_FP and r.get("status")=="FROZEN_SINGLE_USE_OOS_LABEL_COMPLETION_AUTHORIZATION_RESERVATION_V1_2_UNARMED_NO_OOS_ACCESS")
...
def verify_arming(execution_head:str,arming_sha:str)->dict[str,Any]:
    ...
    expected={
      ...
      "prior_label_completion_authorization_fingerprint":PRIOR_LABEL_AUTH_FP,
      "prior_label_completion_consumed_evidence_fingerprint":PRIOR_LABEL_EVIDENCE_FP,
