...
from stage3_financial_pdf_parser_v9 import parse_pdf_bytes as v14_parse_pdf_bytes

METHOD = "CNINFO_ORIGINAL_PDF_PYMUPDF_V9_V14_COORDINATE_ROLE_FALLBACK"


def parse_pdf_bytes(raw: bytes) -> dict:
    parsed = dict(v14_parse_pdf_bytes(raw))
