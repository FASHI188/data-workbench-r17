...
class V1726FullFinalEvidenceTests(unittest.TestCase):
    ...
    def test_machine_artifact_identity_is_frozen(self)->None:
        ...
        self.assertEqual(run["artifact_digest"],"sha256:7f2e707e9192af527ff0444b48caf6bebfbfa1ef7559ec2810b6f47b1790567b")
    ...
    def test_target_scope_and_non_target_identity_are_frozen(self)->None:
        ...
        self.assertFalse(repair["candidate_resolver_reused"])
        self.assertTrue(repair["selected_source_lock_pass"])
        self.assertFalse(repair["non_balance_target_concepts_promoted"])
    ...
    def test_activation_retains_v17_26_historical_authority(self)->None:
        ...
        self.assertTrue(accepted["one_shot_workflow_retired_after_acceptance"])
        self.assertTrue(accepted["evidence_contract_active"])
        ...
        self.assertIn(".github/workflows/stage3-s3g1j-v17-25-full-final-v2.yml",self.activation["removed_one_shot_workflows"])
        ...
        historical_runtime=self.runtime["earlier_historical_full_basis_final"]
        ...
        self.assertEqual(self.runtime["full_basis_last_completed_final"]["generation"],"V17.30")
        self.assertEqual(self.runtime["previous_last_completed_full_basis_final"]["generation"],"V17.29")
        self.assertEqual(self.runtime["previous_full_basis_final"]["generation"],"V17.28")
        self.assertEqual(self.runtime["historical_full_basis_final"]["generation"],"V17.27")
        self.assertEqual(historical_runtime["generation"],"V17.26")
        self.assertEqual(historical_runtime["run"],30733013665)
        self.assertTrue(historical_runtime["retained"])

        classification=self.activation["accepted_v17_26_residual_classification"]
        self.assertTrue(classification["diagnostic_only"])
        self.assertFalse(classification["runtime_authority_changed"])
